$(document).ready(function () {
    ...
    $('.bxslider').bxSlider({autoplay: true, autoplayspeed: 300, pagerCustom: '#bx-pager'});
    ...
    if ($('.kode-product-slide').length) {
        $('.kode-product-slide').slick({infinite: true, speed: 200, autoplay: true, slidesToShow: 1});
    }
    ...
    if ($('.bxslider').length) {
        var wow = new WOW({animateClass: 'animated', offset: 100, callback: function (box) { // console.log("WOW: animating <" + box.tagName.toLowerCase() + ">")
            }});
        wow.init();
    }
    ...
    /*
			==============================================
					Institutions slider script
			==============================================
		*/
    if ($('#insti-slider').length) {
        $('#insti-slider').slick({
            infinite: true,
            centerMode: true,
            centerPadding: "0px",
